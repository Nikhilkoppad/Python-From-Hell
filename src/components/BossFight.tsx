  ...
  const handleExecuteAttack = async () => {
    ...
    try {
      ...
      if (allPassed) {
        ...
        const firstClear = localStorage.getItem(clearKey) !== '1';
        if (firstClear) localStorage.setItem(clearKey, '1');
        setRewardAwarded(firstClear);
        onVictory(firstClear ? 150 : 0);
      } else {
